...
formula = '(1/(pi*(1+x(4)+x(5))))*((1/(x(1)^2))*exp(-(X/x(1)).^2)+(x(4)/(x(2)^2))*exp(-(X/x(2)).^2)+(x(5)/(x(3)^2))*exp(-(X/x(3))));';%公式
...
init_theta_lognsse=[1 30 200.8821 1 1];
init_theta_log=[1 15 300 1  1];
%%%%%%%%%%%%%% -------------------------------------------------%%%%%%%%%%%%%%
